...
export const theme = {
  ...
  borderRadius: "8px",
  iconSize: "32px",
  boxShadow: "2px 4px 10px 0px rgba(0, 0, 0, 0.3)",
  boxShadowHover: "2px 5px 20px 0px rgba(0, 0, 0, 0.4)",
  fonts: {
    h1: `
